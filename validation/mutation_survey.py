...
MUTATIONS: list[tuple[str, str, str, str, str]] = [
    ...
    ("events", "MXE inclusion summed instead of averaged",
     "                inclusion = (a1 + a2) / 2.0  # exon A",
     "                inclusion = (a1 + a2)  # exon A", "caught"),
    ("events", "an alternative-site event measured against the site it does not share",
     '                site_tot = acc_tot if ev.event_type == "A5SS" else don_tot',
     '                site_tot = don_tot if ev.event_type == "A5SS" else acc_tot', "caught"),
